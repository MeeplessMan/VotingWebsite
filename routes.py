...
@app.route('/tutorial')
def tutorial():
    return render_template('voter/tutorial.html', title='Tutorial')
...
@app.route('/contact')
def contact():
    return render_template('voter/contact.html', title='Contact')
@app.route('/index')
def index():
    return render_template('voter/index.html', title='Home')
